...
import { RentContractComponent } from 'app/entities/rent-contract/rent-contract.component';
...
describe('Component Tests', () => {
  describe('RentContract Management Component', () => {
    let comp: RentContractComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RentContractComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rentContracts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
