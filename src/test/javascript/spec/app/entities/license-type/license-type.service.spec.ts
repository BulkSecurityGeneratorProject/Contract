...
describe('Service Tests', () => {
  describe('LicenseType Service', () => {
    let injector: TestBed;
    let service: LicenseTypeService;
    let httpMock: HttpTestingController;
    let elemDefault: ILicenseType;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(LicenseTypeService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new LicenseType(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of LicenseType', async () => {
        const returnedFromService = Object.assign(
          {
            arName: 'BBBBBB',
            enName: 'BBBBBB'
