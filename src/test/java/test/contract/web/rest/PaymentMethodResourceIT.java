...
public class PaymentMethodResourceIT {
    ...
    public void createPaymentMethod() throws Exception {
        ...
        assertThat(testPaymentMethod.getArName()).isEqualTo(DEFAULT_AR_NAME);
        assertThat(testPaymentMethod.getEnName()).isEqualTo(DEFAULT_EN_NAME);
    }
    ...
    public void updatePaymentMethod() throws Exception {
        ...
        PaymentMethod testPaymentMethod = paymentMethodList.get(paymentMethodList.size() - 1);
        assertThat(testPaymentMethod.getArName()).isEqualTo(UPDATED_AR_NAME);
        assertThat(testPaymentMethod.getEnName()).isEqualTo(UPDATED_EN_NAME);
    }
