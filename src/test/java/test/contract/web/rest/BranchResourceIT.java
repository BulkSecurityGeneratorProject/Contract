...
import test.contract.domain.Branch;
import test.contract.repository.BranchRepository;
...
public class BranchResourceIT {
    ...
    public void createBranch() throws Exception {
        ...
        assertThat(testBranch.getArName()).isEqualTo(DEFAULT_AR_NAME);
        assertThat(testBranch.getEnName()).isEqualTo(DEFAULT_EN_NAME);
    }
    ...
    public void updateBranch() throws Exception {
        ...
        Branch testBranch = branchList.get(branchList.size() - 1);
        assertThat(testBranch.getArName()).isEqualTo(UPDATED_AR_NAME);
        assertThat(testBranch.getEnName()).isEqualTo(UPDATED_EN_NAME);
    }
