...
import test.contract.config.Constants;
import test.contract.domain.Authority;
import test.contract.domain.User;
import test.contract.repository.AuthorityRepository;
import test.contract.repository.UserRepository;
import test.contract.security.AuthoritiesConstants;
import test.contract.service.MailService;
import test.contract.service.UserService;
import test.contract.service.dto.PasswordChangeDTO;
import test.contract.service.dto.UserDTO;
import test.contract.web.rest.errors.ExceptionTranslator;
import test.contract.web.rest.vm.KeyAndPasswordVM;
import test.contract.web.rest.vm.ManagedUserVM;
