...
import test.contract.config.audit.AuditEventConverter;
import test.contract.domain.PersistentAuditEvent;
...
import static test.contract.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
