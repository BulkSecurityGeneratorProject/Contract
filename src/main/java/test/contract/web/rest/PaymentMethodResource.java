...
import test.contract.domain.PaymentMethod;
import test.contract.repository.PaymentMethodRepository;
...
/**
 * REST controller for managing {@link test.contract.domain.PaymentMethod}.
 */
@RestController
@RequestMapping("/api")
